  ...
  data() {
    return {
      ...
      tableData: [
        ...
        //   name: "C/C++",
        //   language: "缓冲溢出",
        //   intro: "当程序写入数据超出分配的内存范围时发生。这可能会导致崩溃、数据损坏或恶意代码执行。",
        // },
        {
          name: "C/C++",
          language: "存储泄露",
          intro: "当程序无法释放不再需要的内存时会发生这种情况，从而导致性能下降和系统稳定性问题。",
        },
        {
          name: "C/C++",
          language: "空指针的引用",
          intro: "当程序尝试读取或写入空指针指向的内存位置时发生，导致崩溃或未定义的行为。",
        },
        // {
        //   name: "C/C++",
        //   language: "输入不正当的验证",
        //   intro: "未能正确验证输入可能会导致各种问题，包括 Web 应用程序中的 SQL 注入、缓冲区溢出和跨站点脚本 (XSS) 等安全漏洞。",
        // },
        // {
        //   name: "C/C++",
        //   language: "竞争条件",
        //   intro: "当软件系统的行为取决于程序控制之外的事件的时间和顺序时，就会发生这种情况。",
        // },
        {
          name: "C/C++",
          language: "未初始化的变量",
          intro: "使用尚未初始化的变量可能会导致不可预测的行为和安全漏洞。",
        },
        // {
        //   name: "C/C++",
        //   language: "错误处理不当",
        //   intro: "错误处理不充分可能会导致崩溃、信息泄露和其他意外行为。",
        // },
        // {
        //   name: "C/C++",
        //   language: "资源管理错误",
        //   intro: "文件句柄（handles）、网络连接等系统资源管理不当可能会导致资源耗尽等漏洞。",
        // },
        // {
        //   name: "C/C++",
        //   language: "不安全的库函数",
        //   intro: "使用某些已知不安全的标准库函数（例如 strcpy、sprintf）可能会导致漏洞。",
        // },
        {
          name: "C/C++",
          language: "指针诡计",
          intro: "与指针算术和操作相关的问题，可能导致未经授权的访问或修改内存。",
        },
        {
          name: "Rust",
          language: "随机数依赖漏洞",
        ...
        },
        {
          ...
          name: "Rust",
          language: "Map结构迭代漏洞",
          intro: "Map结构迭代漏洞的核心特征在于在Rust智能合约中使用了HashMap数据结构，同时使用了HashMap迭代器对内部数据进行了迭代。尽管Rust的HashMap迭代本身的结果是不确定性的，但是并不一定会真正影响实际的智能合约的执行。所以对于Map结构迭代漏洞的核心判断依据在于对于HashMap迭代器的使用是否影响了智能合约的链上数据读写。"
    },{
          name: "Rust",
          language: "未处理错误漏洞",
